...
import type { SingleTrack, Datum, FilterTransform, LogTransform, ExonSplitTransform, Assembly, StrConcatTransform, StrReplaceTransform, GenomicLengthTransform, SvTypeTransform, CoverageTransform, DisplaceTransform, JsonParseTransform } from '../gosling.schema';
/**
 * Apply filter
 */
