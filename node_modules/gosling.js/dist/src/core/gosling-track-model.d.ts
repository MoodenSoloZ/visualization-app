import type { ChannelDeep, ChannelTypes, SingleTrack } from './gosling.schema';
...
export declare type ScaleType = ScaleLinear<any, any> | ScaleOrdinal<any, any> | ScaleBand<any> | ScaleSequential<any> | (() => string | number);
export declare class GoslingTrackModel {
     ...
     * A domain is replaced only when the channel is bound with data (i.e., `ChannelDeep`).
     */
    setChannelRange(channelKey: keyof typeof ChannelTypes, range: string[] | number[]): void;
    /**
