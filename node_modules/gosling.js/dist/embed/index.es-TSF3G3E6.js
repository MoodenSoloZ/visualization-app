...
var require_classof_raw = __commonJS({
  "node_modules/core-js/internals/classof-raw.js"(exports, module) {
    ...
    module.exports = function(it) {
      return toString7.call(it).slice(8, -1);
    };
  }
});
...
var require_is_symbol = __commonJS({
  "node_modules/core-js/internals/is-symbol.js"(exports, module) {
    ...
    module.exports = USE_SYMBOL_AS_UID ? function(it) {
      ...
      return isCallable3($Symbol) && Object(it) instanceof $Symbol;
    };
  }
});
...
var require_ordinary_to_primitive = __commonJS({
  "node_modules/core-js/internals/ordinary-to-primitive.js"(exports, module) {
    ...
    module.exports = function(input, pref) {
      var fn, val;
      if (pref === "string" && isCallable3(fn = input.toString) && !isObject2(val = fn.call(input)))
        return val;
      if (isCallable3(fn = input.valueOf) && !isObject2(val = fn.call(input)))
        return val;
      if (pref !== "string" && isCallable3(fn = input.toString) && !isObject2(val = fn.call(input)))
        return val;
...
var require_object_get_own_property_descriptor = __commonJS({
  "node_modules/core-js/internals/object-get-own-property-descriptor.js"(exports) {
    ...
    exports.f = DESCRIPTORS ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor3(O2, P) {
      ...
      if (has(O2, P))
        return createPropertyDescriptor(!propertyIsEnumerableModule.f.call(O2, P), O2[P]);
    };
  }
});
...
var require_object_define_property = __commonJS({
  "node_modules/core-js/internals/object-define-property.js"(exports) {
    ...
    exports.f = DESCRIPTORS ? $defineProperty : function defineProperty(O2, P, Attributes) {
      anObject5(O2);
      P = toPropertyKey(P);
...
var require_to_length = __commonJS({
  "node_modules/core-js/internals/to-length.js"(exports, module) {
    ...
    var min5 = Math.min;
    module.exports = function(argument) {
      return argument > 0 ? min5(toInteger2(argument), 9007199254740991) : 0;
    };
  }
});
...
var require_classof = __commonJS({
  "node_modules/core-js/internals/classof.js"(exports, module) {
    ...
    module.exports = TO_STRING_TAG_SUPPORT ? classofRaw : function(it) {
      var O2, tag, result;
      return it === void 0 ? "Undefined" : it === null ? "Null" : typeof (tag = tryGet(O2 = Object(it), TO_STRING_TAG2)) == "string" ? tag : CORRECT_ARGUMENTS ? classofRaw(O2) : (result = classofRaw(O2)) == "Object" && isCallable3(O2.callee) ? "Arguments" : result;
    };
  }
});
    ...
    module.exports = function(iterable, unboundFunction, options) {
      ...
      if (IS_ITERATOR) {
        ...
        if (isArrayIteratorMethod(iterFn)) {
          for (index2 = 0, length = toLength6(iterable.length); length > index2; index2++) {
...
var require_task = __commonJS({
  "node_modules/core-js/internals/task.js"(exports, module) {
    ...
    var post = function(id) {
      global4.postMessage(String(id), location.protocol + "//" + location.host);
    };
    if (!set || !clear) {
...
var require_regexp_sticky_helpers = __commonJS({
  "node_modules/core-js/internals/regexp-sticky-helpers.js"(exports) {
    ...
    exports.UNSUPPORTED_Y = fails4(function() {
      var re = $RegExp("a", "y");
      re.lastIndex = 2;
      return re.exec("abcd") != null;
    });
    exports.BROKEN_CARET = fails4(function() {
      var re = $RegExp("^r", "gy");
      re.lastIndex = 2;
...
var require_object_define_properties = __commonJS({
  "node_modules/core-js/internals/object-define-properties.js"(exports, module) {
    ...
    module.exports = DESCRIPTORS ? Object.defineProperties : function defineProperties(O2, Properties) {
      anObject5(O2);
      ...
      var key;
      while (length > index2)
        definePropertyModule.f(O2, key = keys[index2++], Properties[key]);
      return O2;
    };
  }
});
...
fixRegExpWellKnownSymbolLogic("match", function(MATCH, nativeMatch, maybeCallNative) {
  return [
    function match(regexp) {
      ...
      return matcher ? matcher.call(regexp, O2) : new RegExp(regexp)[MATCH](toString(O2));
    },
    function(string) {
...
fixRegExpWellKnownSymbolLogic2("replace", function(_2, nativeReplace, maybeCallNative) {
  ...
  return [
    function replace(searchValue, replaceValue) {
      ...
      return replacer ? replacer.call(searchValue, O2, replaceValue) : nativeReplace.call(toString2(O2), searchValue, replaceValue);
    },
    function(string, replaceValue) {
      ...
      for (var i2 = 0; i2 < results.length; i2++) {
        ...
        if (functionalReplace) {
          ...
          var replacement = toString2(replaceValue.apply(void 0, replacerArgs));
        } else {
...
fixRegExpWellKnownSymbolLogic3("split", function(SPLIT, nativeSplit, maybeCallNative) {
  ...
  return [
    function split(separator, limit) {
      ...
      return splitter ? splitter.call(separator, O2, limit) : internalSplit.call(toString5(O2), separator, limit);
    },
...
$6({ target: "String", proto: true, forced: !correctIsRegExpLogic3("includes") }, {
  includes: function includes(searchString) {
    return !!~toString6(requireObjectCoercible6(this)).indexOf(toString6(notARegExp3(searchString)), arguments.length > 1 ? arguments[1] : void 0);
  }
});
...
var t = function(r2, e2) {
  return (t = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t2, r3) {
    ...
    for (var e3 in r3)
      r3.hasOwnProperty(e3) && (t2[e3] = r3[e3]);
  })(r2, e2);
};
function r(r2, e2) {
  function i2() {
...
function e(t2) {
  ...
  for (var e2 = 0; e2 < t2.length; e2++) {
    var i2 = t2[e2];
    if (i2.type === f.CLOSE_PATH)
      r2 += "z";
    else if (i2.type === f.HORIZ_LINE_TO)
      r2 += (i2.relative ? "h" : "H") + i2.x;
    else if (i2.type === f.VERT_LINE_TO)
      r2 += (i2.relative ? "v" : "V") + i2.y;
    else if (i2.type === f.MOVE_TO)
      r2 += (i2.relative ? "m" : "M") + i2.x + " " + i2.y;
    else if (i2.type === f.LINE_TO)
      r2 += (i2.relative ? "l" : "L") + i2.x + " " + i2.y;
    else if (i2.type === f.CURVE_TO)
      r2 += (i2.relative ? "c" : "C") + i2.x1 + " " + i2.y1 + " " + i2.x2 + " " + i2.y2 + " " + i2.x + " " + i2.y;
    else if (i2.type === f.SMOOTH_CURVE_TO)
      r2 += (i2.relative ? "s" : "S") + i2.x2 + " " + i2.y2 + " " + i2.x + " " + i2.y;
    else if (i2.type === f.QUAD_TO)
      r2 += (i2.relative ? "q" : "Q") + i2.x1 + " " + i2.y1 + " " + i2.x + " " + i2.y;
    else if (i2.type === f.SMOOTH_QUAD_TO)
...
function o(t2, r2, e2) {
  ...
  var m3 = Math.pow(a2, 2) * Math.pow(y2, 2) + Math.pow(o2, 2) * Math.pow(c3, 2), O2 = (t2.lArcFlag !== t2.sweepFlag ? 1 : -1) * Math.sqrt(Math.max(0, (Math.pow(a2, 2) * Math.pow(o2, 2) - m3) / m3)), T2 = a2 * y2 / o2 * O2, v2 = -o2 * c3 / a2 * O2, l2 = i([T2, v2], t2.xRot / 180 * n);
  t2.cX = l2[0] + (r2 + s2) / 2, t2.cY = l2[1] + (e2 + u2) / 2, t2.phi1 = Math.atan2((y2 - v2) / o2, (c3 - T2) / a2), t2.phi2 = Math.atan2((-y2 - v2) / o2, (-c3 - T2) / a2), t2.sweepFlag === 0 && t2.phi2 > t2.phi1 && (t2.phi2 -= 2 * n), t2.sweepFlag === 1 && t2.phi2 < t2.phi1 && (t2.phi2 += 2 * n), t2.phi1 *= 180 / n, t2.phi2 *= 180 / n;
}
function s(t2, r2, e2) {
  a(t2, r2, e2);
...
function p(t2, r2, e2, i2) {
  var a2 = r2 - t2, n2 = e2 - r2, o2 = 3 * a2 + 3 * (i2 - e2) - 6 * n2, s2 = 6 * (n2 - a2), u2 = 3 * a2;
  return Math.abs(o2) < 1e-6 ? [-u2 / s2] : function(t3, r3, e3) {
    e3 === void 0 && (e3 = 1e-6);
    var i3 = t3 * t3 / 4 - r3;
    if (i3 < -e3)
      return [];
...
!function(t2) {
  ...
  function e2() {
    ...
    return u2(function(a2, n3, o2) {
      return a2.type & f.SMOOTH_CURVE_TO && (a2.type = f.CURVE_TO, t3 = isNaN(t3) ? n3 : t3, r3 = isNaN(r3) ? o2 : r3, a2.x1 = a2.relative ? n3 - t3 : 2 * n3 - t3, a2.y1 = a2.relative ? o2 - r3 : 2 * o2 - r3), a2.type & f.CURVE_TO ? (t3 = a2.relative ? n3 + a2.x2 : a2.x2, r3 = a2.relative ? o2 + a2.y2 : a2.y2) : (t3 = NaN, r3 = NaN), a2.type & f.SMOOTH_QUAD_TO && (a2.type = f.QUAD_TO, e3 = isNaN(e3) ? n3 : e3, i2 = isNaN(i2) ? o2 : i2, a2.x1 = a2.relative ? n3 - e3 : 2 * n3 - e3, a2.y1 = a2.relative ? o2 - i2 : 2 * o2 - i2), a2.type & f.QUAD_TO ? (e3 = a2.relative ? n3 + a2.x1 : a2.x1, i2 = a2.relative ? o2 + a2.y1 : a2.y1) : (e3 = NaN, i2 = NaN), a2;
    });
  }
  function n2() {
    var t3 = NaN, r3 = NaN;
    return u2(function(e3, i2, a2) {
      if (e3.type & f.SMOOTH_QUAD_TO && (e3.type = f.QUAD_TO, t3 = isNaN(t3) ? i2 : t3, r3 = isNaN(r3) ? a2 : r3, e3.x1 = e3.relative ? i2 - t3 : 2 * i2 - t3, e3.y1 = e3.relative ? a2 - r3 : 2 * a2 - r3), e3.type & f.QUAD_TO) {
        t3 = e3.relative ? i2 + e3.x1 : e3.x1, r3 = e3.relative ? a2 + e3.y1 : e3.y1;
        var n3 = e3.x1, o2 = e3.y1;
        e3.type = f.CURVE_TO, e3.x1 = ((e3.relative ? 0 : i2) + 2 * n3) / 3, e3.y1 = ((e3.relative ? 0 : a2) + 2 * o2) / 3, e3.x2 = (e3.x + 2 * n3) / 3, e3.y2 = (e3.y + 2 * o2) / 3;
      } else
        t3 = NaN, r3 = NaN;
      return e3;
    });
  ...
  function u2(t3) {
    ...
    return function(n3) {
      if (isNaN(i2) && !(n3.type & f.MOVE_TO))
        throw new Error("path must start with moveto");
      var o2 = t3(n3, r3, e3, i2, a2);
      return n3.type & f.CLOSE_PATH && (r3 = i2, e3 = a2), n3.x !== void 0 && (r3 = n3.relative ? r3 + n3.x : n3.x), n3.y !== void 0 && (e3 = n3.relative ? e3 + n3.y : n3.y), n3.type & f.MOVE_TO && (i2 = r3, a2 = e3), o2;
    };
  }
  function O2(t3, r3, e3, i2, n3, o2) {
    return a(t3, r3, e3, i2, n3, o2), u2(function(a2, s2, u3, h2) {
      ...
      a2.type & f.HORIZ_LINE_TO && r3 !== 0 && (a2.type = f.LINE_TO, a2.y = a2.relative ? 0 : u3), a2.type & f.VERT_LINE_TO && e3 !== 0 && (a2.type = f.LINE_TO, a2.x = a2.relative ? 0 : s2), a2.x !== void 0 && (a2.x = a2.x * t3 + O3 * e3 + (p2 ? 0 : n3)), a2.y !== void 0 && (a2.y = m3 * r3 + a2.y * i2 + (p2 ? 0 : o2)), a2.x1 !== void 0 && (a2.x1 = a2.x1 * t3 + a2.y1 * e3 + (p2 ? 0 : n3)), a2.y1 !== void 0 && (a2.y1 = c3 * r3 + a2.y1 * i2 + (p2 ? 0 : o2)), a2.x2 !== void 0 && (a2.x2 = a2.x2 * t3 + a2.y2 * e3 + (p2 ? 0 : n3)), a2.y2 !== void 0 && (a2.y2 = y2 * r3 + a2.y2 * i2 + (p2 ? 0 : o2));
      var v2 = t3 * i2 - r3 * e3;
      if (a2.xRot !== void 0 && (t3 !== 1 || r3 !== 0 || e3 !== 0 || i2 !== 1))
        if (v2 === 0)
          delete a2.rX, delete a2.rY, delete a2.xRot, delete a2.lArcFlag, delete a2.sweepFlag, a2.type = f.LINE_TO;
        else {
          var l2 = a2.xRot * Math.PI / 180, _2 = Math.sin(l2), N2 = Math.cos(l2), x = 1 / T3(a2.rX), d = 1 / T3(a2.rY), A = T3(N2) * x + T3(_2) * d, E = 2 * _2 * N2 * (x - d), C = T3(_2) * x + T3(N2) * d, M = A * i2 * i2 - E * r3 * i2 + C * r3 * r3, R = E * (t3 * i2 + r3 * e3) - 2 * (A * e3 * i2 + C * t3 * r3), g = A * e3 * e3 - E * t3 * e3 + C * t3 * t3, I = (Math.atan2(R, M - g) + Math.PI) % Math.PI / 2, S = Math.sin(I), L = Math.cos(I);
          a2.rX = Math.abs(v2) / Math.sqrt(M * T3(L) + R * S * L + g * T3(S)), a2.rY = Math.abs(v2) / Math.sqrt(M * T3(S) - R * S * L + g * T3(L)), a2.xRot = 180 * I / Math.PI;
        }
      return a2.sweepFlag !== void 0 && 0 > v2 && (a2.sweepFlag = +!a2.sweepFlag), a2;
    });
  }
  function T2() {
    return function(t3) {
  ...
  t2.ROUND = function(t3) {
    ...
    return t3 === void 0 && (t3 = true), r3 === void 0 && (r3 = true), e3 === void 0 && (e3 = true), u2(function(i2, a2, n3, o2, s2) {
      if (isNaN(o2) && !(i2.type & f.MOVE_TO))
        throw new Error("path must start with moveto");
      return r3 && i2.type & f.HORIZ_LINE_TO && (i2.type = f.LINE_TO, i2.y = i2.relative ? 0 : n3), e3 && i2.type & f.VERT_LINE_TO && (i2.type = f.LINE_TO, i2.x = i2.relative ? 0 : a2), t3 && i2.type & f.CLOSE_PATH && (i2.type = f.LINE_TO, i2.x = i2.relative ? o2 - a2 : o2, i2.y = i2.relative ? s2 - n3 : s2), i2.type & f.ARC && (i2.rX === 0 || i2.rY === 0) && (i2.type = f.LINE_TO, delete i2.rX, delete i2.rY, delete i2.xRot, delete i2.lArcFlag, delete i2.sweepFlag), i2;
    });
    ...
    return u2(function(a2, o2, s2, u3, h2) {
      ...
      if (a2.type & f.SMOOTH_CURVE_TO && (p2 = isNaN(r3) ? 0 : o2 - r3, m3 = isNaN(e3) ? 0 : s2 - e3), a2.type & (f.CURVE_TO | f.SMOOTH_CURVE_TO) ? (r3 = a2.relative ? o2 + a2.x2 : a2.x2, e3 = a2.relative ? s2 + a2.y2 : a2.y2) : (r3 = NaN, e3 = NaN), a2.type & f.SMOOTH_QUAD_TO ? (i2 = isNaN(i2) ? o2 : 2 * o2 - i2, n3 = isNaN(n3) ? s2 : 2 * s2 - n3) : a2.type & f.QUAD_TO ? (i2 = a2.relative ? o2 + a2.x1 : a2.x1, n3 = a2.relative ? s2 + a2.y1 : a2.y2) : (i2 = NaN, n3 = NaN), a2.type & f.LINE_COMMANDS || a2.type & f.ARC && (a2.rX === 0 || a2.rY === 0 || !a2.lArcFlag) || a2.type & f.CURVE_TO || a2.type & f.SMOOTH_CURVE_TO || a2.type & f.QUAD_TO || a2.type & f.SMOOTH_QUAD_TO) {
        var O3 = a2.x === void 0 ? 0 : a2.relative ? a2.x : a2.x - o2, T3 = a2.y === void 0 ? 0 : a2.relative ? a2.y : a2.y - s2;
        p2 = isNaN(i2) ? a2.x1 === void 0 ? p2 : a2.relative ? a2.x : a2.x1 - o2 : i2 - o2, m3 = isNaN(n3) ? a2.y1 === void 0 ? m3 : a2.relative ? a2.y : a2.y1 - s2 : n3 - s2;
        var v2 = a2.x2 === void 0 ? 0 : a2.relative ? a2.x : a2.x2 - o2, l2 = a2.y2 === void 0 ? 0 : a2.relative ? a2.y : a2.y2 - s2;
        c3(O3) <= t3 && c3(T3) <= t3 && c3(p2) <= t3 && c3(m3) <= t3 && c3(v2) <= t3 && c3(l2) <= t3 && (y2 = true);
      }
      return a2.type & f.CLOSE_PATH && c3(o2 - u3) <= t3 && c3(s2 - h2) <= t3 && (y2 = true), y2 ? [] : a2;
    });
    ...
    return u2(function(t3, r3, e3) {
      return f.ARC === t3.type ? function(t4, r4, e4) {
        var a2, n3, s2, u3;
        t4.cX || o(t4, r4, e4);
        for (var y2 = Math.min(t4.phi1, t4.phi2), p2 = Math.max(t4.phi1, t4.phi2) - y2, m3 = Math.ceil(p2 / 90), O3 = new Array(m3), T3 = r4, v2 = e4, l2 = 0; l2 < m3; l2++) {
          var _2 = c(t4.phi1, t4.phi2, l2 / m3), N2 = c(t4.phi1, t4.phi2, (l2 + 1) / m3), x = N2 - _2, d = 4 / 3 * Math.tan(x * h / 4), A = [Math.cos(_2 * h) - d * Math.sin(_2 * h), Math.sin(_2 * h) + d * Math.cos(_2 * h)], E = A[0], C = A[1], M = [Math.cos(N2 * h), Math.sin(N2 * h)], R = M[0], g = M[1], I = [R + d * Math.sin(N2 * h), g - d * Math.cos(N2 * h)], S = I[0], L = I[1];
          O3[l2] = { relative: t4.relative, type: f.CURVE_TO };
          var H = function(r5, e5) {
            var a3 = i([r5 * t4.rX, e5 * t4.rY], t4.xRot), n4 = a3[0], o2 = a3[1];
            return [t4.cX + n4, t4.cY + o2];
          };
          a2 = H(E, C), O3[l2].x1 = a2[0], O3[l2].y1 = a2[1], n3 = H(S, L), O3[l2].x2 = n3[0], O3[l2].y2 = n3[1], s2 = H(R, g), O3[l2].x = s2[0], O3[l2].y = s2[1], t4.relative && (O3[l2].x1 -= T3, O3[l2].y1 -= v2, O3[l2].x2 -= T3, O3[l2].y2 -= v2, O3[l2].x -= T3, O3[l2].y -= v2), T3 = (u3 = [O3[l2].x, O3[l2].y])[0], v2 = u3[1];
        }
        return O3;
    ...
    return u2(function(t3, r3, e3) {
      return t3.relative && (r3 = 0, e3 = 0), f.ARC === t3.type && o(t3, r3, e3), t3;
    });
    ...
    var t3 = function(t4) {
      ...
      if (u3.type & f.DRAWING_COMMANDS && (O3(e3), T3(n3)), u3.type & f.HORIZ_LINE_TO && O3(u3.x), u3.type & f.VERT_LINE_TO && T3(u3.y), u3.type & f.LINE_TO && (O3(u3.x), T3(u3.y)), u3.type & f.CURVE_TO) {
        O3(u3.x), T3(u3.y);
        for (var v2 = 0, l2 = p(e3, u3.x1, u3.x2, u3.x); v2 < l2.length; v2++) {
          0 < (w = l2[v2]) && 1 > w && O3(m(e3, u3.x1, u3.x2, u3.x, w));
        }
        for (var _2 = 0, N2 = p(n3, u3.y1, u3.y2, u3.y); _2 < N2.length; _2++) {
          0 < (w = N2[_2]) && 1 > w && T3(m(n3, u3.y1, u3.y2, u3.y, w));
        }
      }
      if (u3.type & f.ARC) {
        O3(u3.x), T3(u3.y), o(u3, e3, n3);
        for (var x = u3.xRot / 180 * Math.PI, d = Math.cos(x) * u3.rX, A = Math.sin(x) * u3.rX, E = -Math.sin(x) * u3.rY, C = Math.cos(x) * u3.rY, M = u3.phi1 < u3.phi2 ? [u3.phi1, u3.phi2] : -180 > u3.phi2 ? [u3.phi2 + 360, u3.phi1 + 360] : [u3.phi2, u3.phi1], R = M[0], g = M[1], I = function(t4) {
          var r4 = t4[0], e4 = t4[1], i3 = 180 * Math.atan2(e4, r4) / Math.PI;
          return i3 < R ? i3 + 360 : i3;
        }, S = 0, L = s(E, -d, 0).map(I); S < L.length; S++) {
          (w = L[S]) > R && w < g && O3(y(u3.cX, d, E, w));
        }
        for (var H = 0, U = s(C, -A, 0).map(I); H < U.length; H++) {
          var w;
          (w = U[H]) > R && w < g && T3(y(u3.cY, A, C, w));
        }
      }
      return r3;
    });
...
var _ = function(t2) {
  ...
  return r(e2, t2), e2.prototype.finish = function(t3) {
    ...
    for (var i2 = function(t4) {
      ...
      var n2 = t3[a2], o2 = !(this.curCommandType !== f.ARC || this.curArgs.length !== 3 && this.curArgs.length !== 4 || this.curNumber.length !== 1 || this.curNumber !== "0" && this.curNumber !== "1"), s2 = l(n2) && (this.curNumber === "0" && n2 === "0" || o2);
      if (!l(n2) || s2)
        if (n2 !== "e" && n2 !== "E")
          if (n2 !== "-" && n2 !== "+" || !this.curNumberHasExp || this.curNumberHasExpDigits)
            if (n2 !== "." || this.curNumberHasExp || this.curNumberHasDecimal || o2) {
              if (this.curNumber && this.curCommandType !== -1) {
                ...
                this.curArgs.push(u2), this.curArgs.length === N[this.curCommandType] && (f.HORIZ_LINE_TO === this.curCommandType ? i2({ type: f.HORIZ_LINE_TO, relative: this.curCommandRelative, x: u2 }) : f.VERT_LINE_TO === this.curCommandType ? i2({ type: f.VERT_LINE_TO, relative: this.curCommandRelative, y: u2 }) : this.curCommandType === f.MOVE_TO || this.curCommandType === f.LINE_TO || this.curCommandType === f.SMOOTH_QUAD_TO ? (i2({ type: this.curCommandType, relative: this.curCommandRelative, x: this.curArgs[0], y: this.curArgs[1] }), f.MOVE_TO === this.curCommandType && (this.curCommandType = f.LINE_TO)) : this.curCommandType === f.CURVE_TO ? i2({ type: f.CURVE_TO, relative: this.curCommandRelative, x1: this.curArgs[0], y1: this.curArgs[1], x2: this.curArgs[2], y2: this.curArgs[3], x: this.curArgs[4], y: this.curArgs[5] }) : this.curCommandType === f.SMOOTH_CURVE_TO ? i2({ type: f.SMOOTH_CURVE_TO, relative: this.curCommandRelative, x2: this.curArgs[0], y2: this.curArgs[1], x: this.curArgs[2], y: this.curArgs[3] }) : this.curCommandType === f.QUAD_TO ? i2({ type: f.QUAD_TO, relative: this.curCommandRelative, x1: this.curArgs[0], y1: this.curArgs[1], x: this.curArgs[2], y: this.curArgs[3] }) : this.curCommandType === f.ARC && i2({ type: f.ARC, relative: this.curCommandRelative, rX: this.curArgs[0], rY: this.curArgs[1], xRot: this.curArgs[2], lArcFlag: this.curArgs[3], sweepFlag: this.curArgs[4], x: this.curArgs[5], y: this.curArgs[6] })), this.curNumber = "", this.curNumberHasExpDigits = false, this.curNumberHasExp = false, this.curNumberHasDecimal = false, this.canParseCommandOrComma = true;
              }
              if (!v(n2))
                if (n2 === "," && this.canParseCommandOrComma)
                  ...
                  if (s2)
                    ...
                    if (this.canParseCommandOrComma = false, n2 !== "z" && n2 !== "Z")
                      if (n2 === "h" || n2 === "H")
                        this.curCommandType = f.HORIZ_LINE_TO, this.curCommandRelative = n2 === "h";
                      else if (n2 === "v" || n2 === "V")
                        this.curCommandType = f.VERT_LINE_TO, this.curCommandRelative = n2 === "v";
                      else if (n2 === "m" || n2 === "M")
                        this.curCommandType = f.MOVE_TO, this.curCommandRelative = n2 === "m";
                      else if (n2 === "l" || n2 === "L")
                        this.curCommandType = f.LINE_TO, this.curCommandRelative = n2 === "l";
                      else if (n2 === "c" || n2 === "C")
                        this.curCommandType = f.CURVE_TO, this.curCommandRelative = n2 === "c";
                      else if (n2 === "s" || n2 === "S")
                        this.curCommandType = f.SMOOTH_CURVE_TO, this.curCommandRelative = n2 === "s";
                      else if (n2 === "q" || n2 === "Q")
                        this.curCommandType = f.QUAD_TO, this.curCommandRelative = n2 === "q";
                      else if (n2 === "t" || n2 === "T")
                        this.curCommandType = f.SMOOTH_QUAD_TO, this.curCommandRelative = n2 === "t";
                      else {
                        if (n2 !== "a" && n2 !== "A")
                          throw new SyntaxError('Unexpected character "' + n2 + '" at index ' + a2 + ".");
                        this.curCommandType = f.ARC, this.curCommandRelative = n2 === "a";
                      }
                    else
                      r2.push({ type: f.CLOSE_PATH }), this.canParseCommandOrComma = true, this.curCommandType = -1;
                  }
                else
...
var N = ((O = {})[f.MOVE_TO] = 2, O[f.LINE_TO] = 2, O[f.HORIZ_LINE_TO] = 1, O[f.VERT_LINE_TO] = 1, O[f.CLOSE_PATH] = 0, O[f.QUAD_TO] = 4, O[f.SMOOTH_QUAD_TO] = 2, O[f.CURVE_TO] = 6, O[f.SMOOTH_CURVE_TO] = 4, O[f.ARC] = 7, O);
...
if (NOT_GENERIC || INCORRECT_NAME) {
  redefine2(RegExp.prototype, TO_STRING, function toString7() {
    ...
    var rf = R.flags;
    var f2 = $toString(rf === void 0 && R instanceof RegExp && !("flags" in RegExpPrototype) ? flags.call(R) : rf);
    return "/" + p2 + "/" + f2;
  }, { unsafe: true });
}
...
var PathParser = class extends f {
  constructor(path) {
...
***************************************************************************** */
//# sourceMappingURL=index.es-TSF3G3E6.js.map
